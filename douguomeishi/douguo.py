...
#def handle_Recipe(ids):    
    for detail_id in ids:
        ...
        #菜谱详情页地址
        detail_url = 'http://api.douguo.net/recipe/detail/' + str(detail_id)
...
if __name__ == '__main__':
    handle_index()
#    handle_Recipe(queue_list.get())
#定义最大线程
#pool = ThreadPoolExecutor(max_workers=20)
#while queue_list.qsize() > 0:
#    pool.submit(handle_index,queue_list.get())
